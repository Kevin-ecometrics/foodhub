...
export default function Header({ loading, onRefresh, onLogout }: HeaderProps) {
  return (
      ...
      <div style={{ display:"flex", alignItems:"center", gap:8 }}>
        ...
        {onLogout && (
          <button
            onClick={onLogout}
            title="Cerrar sesión"
            style={{ background:"var(--surface)",color:"var(--muted)",border:"1px solid var(--border)",borderRadius:9,padding:"8px 12px",fontSize:13,fontWeight:700,cursor:"pointer",fontFamily:"inherit" }}
          >
            Salir
          </button>
        )}
