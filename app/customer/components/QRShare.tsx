...
import { FaQrcode, FaUtensils, FaHistory, FaSpinner, FaExclamationTriangle } from "react-icons/fa";
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center px-4">
        <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            No se pudo identificar la mesa. Por favor, regresa al menú principal.
          </p>
          <button
                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (parent) {
                      ...
                      fallbackDiv.className = 'w-64 h-64 bg-gray-200 flex items-center justify-center rounded-xl';
